export const metadata = { title: 'Terms of Service — ESG Astraa' }

export default function TermsPage() {
  return (
    <section className="py-24 md:py-32 bg-white">
      <div className="max-w-3xl mx-auto px-6">
        <h1 className="font-display text-3xl md:text-4xl font-bold text-base mb-8">Terms of Service</h1>
        <div className="prose prose-slate max-w-none space-y-6 text-slate-body/80 leading-relaxed">
          <p>These Terms of Service govern your use of the ESG Astraa website and our consulting services. By accessing our website or engaging our services, you agree to these terms.</p>
          ...
          <p>Our advisory services are provided based on professional judgement and available information. We do not guarantee specific regulatory outcomes or financial results.</p>
          <h2 className="font-display text-xl font-bold text-base !mt-10 !mb-4">Governing Law</h2>
